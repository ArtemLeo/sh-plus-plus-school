...
public class Assignment2Part1 {
    ...
    private static void enterTheValuesOfCoefficients() {
        ...
        System.out.println("Please enter a:");                // Ask the user to enter the coefficient "a"
        a = scanner.nextDouble();                             // Save the gotten value in the variable "a"
        System.out.println("Please enter b:");                // Ask the user to enter the coefficient "b"
        b = scanner.nextDouble();                             // Save the gotten value in the variable "b"
        System.out.println("Please enter c:");                // Ask the user to enter the coefficient "c"
        c = scanner.nextDouble();                             // Save the gotten value in the variable "c"
    }

    /*
     * Method: findTheRootsOfQuadraticEquation()
     * Description: Calculate the discriminant and based on the result we find the root of the quadratic equation
     */
