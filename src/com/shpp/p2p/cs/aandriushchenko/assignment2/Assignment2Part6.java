...
public class Assignment2Part6 extends GraphicsProgram {
    ...
    private static final int OVALS_QUANTITY = 6;                                // Quantity of ovals in caterpillar
    ...
    private static final double OFFSET_BETWEEN_OVALS_X = OVAL_DIAMETER * 0.65;  // Offset in X between ovals in pair
    private static final double OFFSET_BETWEEN_OVALS_Y = OVAL_DIAMETER * 0.35;  // Offset in Y between ovals in pair
    ...
    private static final double START_X = 0;                                     // Starting position in X coordinates
    private static final double START_Y = OFFSET_BETWEEN_OVALS_Y;                // Starting position in Y coordinates
    ...
    private void buildSingleOval(double x, double y) {
        ...
        borderOval.setFillColor(BORDER_COLOR);                         // Set the fill color of the oval border
        ...
        bodyOval.setFillColor(OVAL_COLOR);                             // Set the fill color of the oval body
